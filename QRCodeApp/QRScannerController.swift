...
//            captureMetadataOutput.metadataObjectTypes = [AVMetadataObject.ObjectType.qr]
    ...
    @objc func bigButtonTapped() {
        print("qrlabel.text : \(qrlabel.text)")
...
extension QRScannerController: AVCaptureMetadataOutputObjectsDelegate {
    func metadataOutput(_ output: AVCaptureMetadataOutput, didOutput metadataObjects: [AVMetadataObject], from connection: AVCaptureConnection) {
        ...
        if metadataObjects.count == 0 {
            ...
            qrlabel?.frame = (qrCodeFrameView?.alignmentRect(forFrame: .init(x: 0, y: 0, width: 50, height: 50)))!
            ...
            qrlabel.font = UIFont.boldSystemFont(ofSize: 20.0)
        ...
        if supportedCodeTypes.contains(metadataObj.type) {
            ...
            qrlabel.frame = barCodeObject!.bounds
